...
struct Ts8180InBlock {
    ...
    char _comm_order_typez2;
    char conc_gubunz1[1];
    char _conc_gubunz1;
    char inq_seq_gubunz1[1];
    char _inq_seq_gubunz1;
    char sort_gubunz1[1];
    char _sort_gubunz1;
    char sell_buy_typez1[1];
    char _sell_buy_typez1;
    char mrgn_typez1[1];
    char _mrgn_typez1;
    char accnt_admin_typez1[1];
    char _accnt_admin_typez1;
    char order_noz10[10];
    char _order_noz10;
    char ctsz56[56];
    char _ctsz56;
...
struct Ts8180OutBlock1 {
    ...
    char _order_unit_pricez12;
    char conc_unit_pricez12[12];
    char _conc_unit_pricez12;
    char crctn_canc_qtyz10[10];
    char _crctn_canc_qtyz10;
...
struct Ts8118OutBlock {
    ...
    char _split_order_ynz1;
    char send_mkt_codez3[3];
    char _send_mkt_codez3;
    char exch_reject_codez4[4];
    char _exch_reject_codez4;
    char alt_exch_reject_codez4[4];
    char _alt_exch_reject_codez4;
